...
public class AdminMainFormController {
    ...
    public AnchorPane adminMainFormContext;
        ...
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                ...
                case "imgSearch":
                    ...
                    break;
                case "imgReports":
                    root = FXMLLoader.load(this.getClass().getResource("../view/ReportForm.fxml"));
                    break;
            }

            if (root != null) {
                Scene subScene = new Scene(root);
                Stage primaryStage = (Stage) this.adminMainFormContext.getScene().getWindow();
        ...
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgItem":
                    ...
                    break;
                case "imgSearch":
                    lblMenu.setText("Details");
                    lblDescription.setText("Click here if you want to search details");
                    break;
                case "imgReports":
                    lblMenu.setText("Reports");
                    lblDescription.setText("Click if you want to search reports");
                    break;
            }
    ...
    public void exit(MouseEvent mouseEvent) throws IOException {
        ...
        Stage window = (Stage) adminMainFormContext.getScene().getWindow();
