...
public class ViewDetailFormController {
    ...
    public void navigate(MouseEvent event) throws IOException, JRException {
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgCustomer":
                    try {
                        design = JRXmlLoader.load(this.getClass().getResourceAsStream("/view/JasperReports/Customer.jrxml"));
                ...
                case "imgOrders":
                    try {
                        design = JRXmlLoader.load(this.getClass().getResourceAsStream("/view/JasperReports/Orders.jrxml"));
                        compileReport = JasperCompileManager.compileReport(design);
    ...
    public void playMouseEnterAnimation(MouseEvent event) {
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgCustomer":
                    lblMenu.setText("View Customer");
                    lblDescription.setText("Click view to all customers");
                    break;
                case "imgItem":
                    lblMenu.setText("View Items");
                    lblDescription.setText("Click view to all items");
                    break;
                case "imgOrders":
                    lblMenu.setText("View Orders");
                    lblDescription.setText("Click view to all orders");
                    break;
            }
